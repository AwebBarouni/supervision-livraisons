...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull ConstraintLayout loginRoot, @NonNull ProgressBar progressBar,
      @NonNull TextInputLayout tilEmail, @NonNull TextInputLayout tilPassword,
      @NonNull TextView tvAppName, @NonNull TextView tvLogo) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.loginRoot;
      ConstraintLayout loginRoot = ViewBindings.findChildViewById(rootView, id);
      if (loginRoot == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ScrollView) rootView, btnLogin, etEmail, etPassword,
          loginRoot, progressBar, tilEmail, tilPassword, tvAppName, tvLogo);
    }
